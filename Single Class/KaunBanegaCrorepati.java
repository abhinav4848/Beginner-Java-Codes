...
public class KaunBanegaCrorepati
{
    ...
    public static int for51, fiftyfifty=0, phoneFriend=0, audience=0, fourthLife=0;
    public static int password=0 , ddip=0, ddipAns=0, ddipStart=0 , totalddip=0;
    ...
    public static void lifeFourth()throws IOException
    {
        BufferedReader ak=new BufferedReader(new InputStreamReader(System.in));
        if(fourthLife==0)
        {
            System.out.println("Choose if you want to use either Flip the Question or Double Dip.\n1:Flip \n2:Double Dip.");
            int choose=((ak.readLine()).charAt(0))-48;
            ddip=2;
            ...
            {
                System.out.println("You chose 1:Flip the Question.");//Code Incomplete... HELP!!! If user chooses this option, he moves to the next question.
                /*IDEA: compare the current "cash" with all possible options it could have been assigned after the 9th Question.
                 * so whatever amount matches, run the question of next value again.
                 * Problem: We still haven't terminated the prev question fro which the help line was used; to run the question function afresh.
                 * Problem: the Flipping may still return the same question.
                 */
                
            }
            else if(choose==2)
            {
                System.out.println("You chose 2:Double Dip, you now get to choose two answers to your question.");
                System.out.println("The Options were \n"+cor1+"\n"+cor2+"\n"+cor3+"\n"+cor4);
                System.out.println("P.S. You can choose another Life Line if you have both the times under Double Dip, or see help if you wish. Remember that.");
                ddipStart=1;
                carryon();
                if(ddipAns!=1)//if checkansdoesn't assign 1 to ddipAns, this meant the first attempt at answering was wrong and the second time is allowed to answer.
                    carryon();
            }
            ddipStart=0;
        }
        ...
        {
            System.out.println("You already used the Fourth Special life line once, please choose another life line or give the answer...");
            carryon();
        }
    }
    public static void carryon()throws IOException
    {
        ...
        else if(ch=='r' || ch=='R')//Although this is also a lifeline, I didn't want it to first go to helpLine() and then go again to lifeFourth()
        {
            if(ddip==1)
            {
                lifeFourth();
            ...
            {
                System.out.println("You are not entitled to use the Fourth Life Line option yet. Wait until you answer the 9th question (Lock Point)");
                carryon();
            }
        }
        else if(ch=='z' || ch=='Z')
    ...
    public static void checker(int ans, int entAns)
    {
        if(ans==entAns)
        {
            ...
            if(last==1)
                bye();
            if (ddipStart==1)//This says that if ddip was started for this question, and if the answer was right the first time itself, lifeFourth() will not ask to enter a second value.
                ddipAns=1;
        }
        else
        {
            ...
            else
            {
                ...
                {
                    System.out.println("Sorry, you could not get the answer even in the second chance. We will have to say good bye to you.");
                    System.out.println("You are Leaving with Rs."+finalcash+"\nNice to have played with you, Bye. Bye......");
                    bye();
                    conf=1;//don't Modify this value.
                }
    ...
    */
    public static void main(String args[])throws IOException
    {
        ...
        for(int i=1; i<2; i++)
        {
            ...
            if(conf==1)
                break;
            System.out.println("You can now press 'R' to choose between either 'Flip the Question' or 'Double Dip'");
            ddip=1;
            question10();
            if(conf==1)
                break;
